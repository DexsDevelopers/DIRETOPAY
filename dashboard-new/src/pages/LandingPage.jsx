        ...
        <div className="bg-[#050505] min-h-screen text-white font-['Outfit'] overflow-x-hidden selection:bg-primary selection:text-white">
            ...
            <div className="sticky top-0 bg-[#08080a]/80 backdrop-blur-2xl border-b border-white/5 py-3 px-6 text-center z-[60]">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                    ...
                    <a href="https://whatsapp.com/channel/0029VbC56v0GZNComh5KQ73J" rel="noopener noreferrer" target="_blank" className="text-[11px] font-black uppercase tracking-widest text-white hover:text-primary transition-colors flex items-center gap-2">Explorar <ArrowRight size={12} /></a>
                </div>
            </div>
