                    ...
                    <div className="bg-white border border-emerald-100 shadow-[0_20px_60px_rgba(30,164,101,0.1)] p-8 md:p-10 rounded-[48px] relative overflow-hidden">
                        ...
                        {sent ? (
                            <div className="text-center space-y-6">
                                ...
                                <Link
                                    to="/login"
                                    className="block w-full h-14 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-full font-black text-base flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition-all shadow-[0_12px_40px_rgba(30,164,101,0.3)]"
                                >
