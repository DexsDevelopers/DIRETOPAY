...
export default function SettingsPage({ userData, onProfileSaved }) {
    ...
    const handleCopyCurl = () => {
        const curl = `curl -X POST https://diretopay.site/api.php \\
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input type="email" defaultValue={userData?.email || "vendedor@diretopay.site"} disabled className="w-full bg-gray-100 border border-gray-200 rounded-full px-6 py-4 font-bold text-gray-500 opacity-50 cursor-not-allowed" />
                                        </div>
                                    </div>
...
{`curl -X POST https://diretopay.site/api.php \\
    ...
    "customer_name": "Cliente Teste"
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5 space-y-2">
                                        ...
                                        <p className="text-[11px] font-mono text-gray-400">https://diretopay.site/api.php</p>
                                    </div>
                                    <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5 space-y-2">
