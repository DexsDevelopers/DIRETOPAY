...
const accounts = [
  {
    ...
    description:
      "A conta nominal mais estável da plataforma, com a maior taxa de conversão — acima de 70%. Ideal para quem busca consistência no recebimento com saque disponível de forma instantânea.",
    fees: [
      {
  ...
  },
  {
    ...
    description:
      "Conta nominal em fase de testes com taxa mais competitiva. Risco elevado de reembolso e MED (Mecanismo Especial de Devolução) durante o período de homologação.",
    warning:
      "Risco de reembolso e MED ativo durante os testes. Use com cautela.",
    fees: [
      {
        icon: <Percent size={11} />,
  ...
  },
  {
    ...
    description:
      "Conta nominal com repasse automático. Toda venda realizada é transferida na hora para a sua chave Pix cadastrada (após as taxas).",
    fees: [
      {
        icon: <Percent size={11} />,
      ...
      {
        icon: <Zap size={11} />,
        label: "Repasse automático na hora",
        color:
          "dark:bg-green-500/15 dark:text-green-300 dark:border-green-500/20 bg-green-50 text-green-700 border-green-200",
      },
    ],
  },
  {
    ...
    accentDark: "from-violet-500/10 via-violet-500/3 to-transparent",
    accentLight: "from-violet-50 via-violet-50/30 to-transparent",
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
      ...
      >
        ...
        <span>
          Contas identificadas nominalmente por segurança. A taxa cobrada muda
          conforme a conta selecionada.
        </span>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-gray-400 font-medium leading-normal">
                  Acumule as vendas na plataforma e solicite saques manuais
                  quando desejar.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-gray-400 font-medium leading-normal">
                  A cada venda que cair na plataforma, um saque Pix
                  correspondente será feito automaticamente.
                </p>
              </div>
            </div>
          </div>
