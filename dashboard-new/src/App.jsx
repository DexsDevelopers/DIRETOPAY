...
const CheckoutBuilderPage = React.lazy(
  () => import("./pages/CheckoutBuilderPage"),
);
...
const PremiacoesPublicPage = React.lazy(
  () => import("./pages/PremiacoesPublicPage"),
);
    ...
    try {
      ...
      if (data.success) {
        ...
        setDashboardData((prev) =>
          prev ? { ...prev, notifications: data.notifications } : data,
        );
      }
    } catch (err) {}
  };
      ...
      <>
        ...
        <React.Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route
              path="/login"
              element={<LoginPage onLogin={fetchDashboard} />}
            />
              ...
              element={
                <PrivateRoute>
                  <DashboardLayout {...commonProps} activeTab="pix">
                    <PixPage
                      handleManualPix={handleManualPix}
                      activePix={activePix}
                      setActivePix={setActivePix}
                      balance={commonProps.balance}
                  ...
                  <DashboardLayout {...commonProps} activeTab="saques">
                    <WithdrawalsPage
                      ...
                      availableForWithdraw={
                        dashboardData?.available_for_withdraw
                      }
