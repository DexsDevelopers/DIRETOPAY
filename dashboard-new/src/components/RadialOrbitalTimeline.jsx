...
/* ── Helpers inline (substituem shadcn Badge/Card/Button, sem deps extras) ── */
...
function OutlineButton({ className, children, onClick }) {
  return (
    <button
      onClick={onClick}
      className={cn(
        "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors border",
        className
      )}
    >
      {children}
