...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($fields['TELEGRAM_BOT_TOKEN']) && !empty($fields['TELEGRAM_CHAT_ID'])) {
        $testMsg = "✅ <b>DiretoPay — Bot Admin conectado!</b>\n\n🔔 Notificações ativas:\n• 💰 Vendas confirmadas\n• 👤 Novos cadastros\n• 🏦 Saques solicitados";
...
<head>
    ...
    <title>Setup Telegram — DiretoPay</title>
    <style>
...
<body>
<div class="container">
    <h1>👻 <span>DiretoPay</span> — Setup Telegram</h1>
    ...
    <form method="POST">
        ...
        <div class="card">
            ...
            <input type="text" name="user_username" placeholder="DiretoPayBot" value="<?= htmlspecialchars($current['TELEGRAM_USER_BOT_USERNAME'] ?? '') ?>">
