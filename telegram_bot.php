<?php
/**
 * telegram_bot.php — Webhook do Bot Telegram para DiretoPay
 *
 * Registrar: POST https://api.telegram.org/bot{TOKEN}/setWebhook
 *   {"url": "https://DIRETOPAY.site/telegram_bot.php?secret=SEU_SECRET"}
 *
...
function handlePixGeneration(string $chatId, float $amount): void {
    ...
    if ($currentPixGoKey === 'SUA_API_KEY_AQUI' || empty($currentPixGoKey)) {
        ...
        $pixCode = '00020126360014br.gov.bcb.pix0114000000000000005204000053039865802BR5913DiretoPay6009SAOPAULO62070503***6304ABCD';
